...
public class RegularWizardUpdater {
    ...
    private static void tick(ServerWorld world) {
        ...
        packetCountManager.updateWatchRadius(((TSCSAccessor)world.getChunkManager().threadedAnvilChunkStorage).getWatchDistance());

        var entityTrackers = ((TSCSAccessor)world.getChunkManager().threadedAnvilChunkStorage).getEntityTrackers();
        int seed = 0;
